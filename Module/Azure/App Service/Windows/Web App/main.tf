...
resource "azurerm_windows_web_app" "appservice-windows" {
  name                = var.name
  resource_group_name = var.resource_group_name
  location            = var.location
  ...
  site_config {
    application_stack {
      ...
      dotnet_core_version          = var.stack_choice == "dotnet-core" ? var.dotnet_core_version : null
      node_version                 = var.stack_choice == "node" ? var.node_version : null
      php_version                  = var.stack_choice == "php" ? var.php_version : null
      python                       = var.stack_choice == "python" ? var.python : null
      java_embedded_server_enabled = var.stack_choice == "java" ? var.java_embedded_server_enabled : null
